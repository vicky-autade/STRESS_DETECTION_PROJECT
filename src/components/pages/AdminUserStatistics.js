    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`https://stress-detection-backend.vercel.app/api/admin/parameters/latest?userId=${user._id}`, {
        ...
        const fetchHistory = async () => {
            try {
                const response = await axios.get(`https://stress-detection-backend.vercel.app/api/admin/parameters/history?userId=${user._id}`, {
                    withCredentials: true,
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("jwt")}`,
                    },
